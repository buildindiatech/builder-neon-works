  ...
  const projects = [
    {
      ...
      location: "Dholera",
      image:
        "https://api.builder.io/api/v1/image/assets/TEMP/3c8e8a6b9c1ef066b52d4753db3b75295521778b?width=1212",
    },
    {
      id: 2,
      name: "Rajpath Grand",
      location: "Dholera",
      image:
        "https://api.builder.io/api/v1/image/assets/TEMP/00b843e590645b80eff9c3760bcdeb23114dabe0?width=1146",
    },
    {
      id: 3,
      name: "Green City",
      location: "Dholera",
      image:
        "https://api.builder.io/api/v1/image/assets/TEMP/67383ef89216c9b9b0623f0a3f153f7b59d63b67?width=980",
    },
    {
      id: 4,
      ...
      >
        ...
        <div className="absolute bottom-40 left-40 text-white max-w-3xl">
          ...
          <p className="font-poppins text-xl mb-8 leading-relaxed">
            Rajpath Enclave will provide skillfully designed Residential Plot
                ...
                <div className="bg-gray-100 rounded-lg overflow-hidden w-80 hover:shadow-lg transition-shadow cursor-pointer">
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center gap-2">
                      <svg
                        className="w-3 h-5 text-gray-600"
                        fill="currentColor"
                        viewBox="0 0 12 20"
                      >
                        ...
                        <defs>
                          <clipPath id="clip0_200_1708">
                            <rect
                              ...
                              height="18.8571"
                              fill="white"
                              transform="translate(0.5 0.571289)"
                            />
                          </clipPath>
                        </defs>
                      </svg>
