                    ...
                    <div className="flex items-center justify-center w-10 h-10 bg-white rounded-full">
                      <svg className="w-4 h-4" viewBox="0 0 18 18" fill="none">
                        <g clipPath="url(#clip0_348_5550)">
                          <path d="M16.4047 4.5557C16.4047 3.74089 15.738 3.07422 14.9232 3.07422H3.07133C2.25651 3.07422 1.58984 3.74089 1.58984 4.5557M16.4047 4.5557V13.4446C16.4047 14.2594 15.738 14.9261 14.9232 14.9261H3.07133C2.25651 14.9261 1.58984 14.2594 1.58984 13.4446V4.5557M16.4047 4.5557L8.99725 9.74089L1.58984 4.5557" stroke="#1E1E1E" strokeWidth="1.48148" strokeLinecap="round" strokeLinejoin="round"/>
                        </g>
                        <defs>
                          <clipPath id="clip0_348_5550">
                            <rect width="17.7778" height="17.7778" fill="white" transform="translate(0.109375 0.111328)"/>
                          </clipPath>
                        </defs>
                      </svg>
                    </div>
