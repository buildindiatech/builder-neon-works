    ...
    <div className="w-full">
      ...
      <section className="relative h-screen bg-gray-100">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-3/4 text-center px-4">
          ...
          <p className="font-poppins text-xl text-white mb-12 max-w-3xl">
            Join Thousands Already Investing In Gujarat's Fastest - Growing
            Smart Zones
          </p>
      ...
      <section className="py-24 bg-gray-100">
        <div className="container mx-auto px-20 flex flex-col">
          ...
          <div className="text-center mb-20">
            <h2 className="font-merriweather text-5xl text-black mb-6">
              Why Choose Us
            </h2>
            <p className="font-poppins text-xl text-gray-600 max-w-3xl mx-auto">
              Delivering secure investments with transparency, trust, and
          ...
          <div className="flex flex-col lg:flex-row items-center gap-20">
            ...
            <div className="flex-1 space-y-6">
              {[
                ...
                <div
                  key={index}
                  className="flex items-center space-x-6 bg-white p-6 rounded-lg border border-gray-200"
                >
                  <div className="w-14 h-14 bg-gray-100 rounded-lg flex items-center justify-center flex-shrink-0">
                    {feature.icon === "location" ? (
                      ...
                      >
                        <path
                          d="M6 29.25C6 28.2554 6.39509 27.3016 7.09835 26.5983C7.80161 25.8951 8.75544 25.5 9.75 25.5H30M6 29.25C6 30.2446 6.39509 31.1984 7.09835 31.9016C7.80161 32.6049 8.75544 33 9.75 33H30V3H9.75C8.75544 3 7.80161 3.39509 7.09835 4.09835C6.39509 4.80161 6 5.75544 6 6.75V29.25Z"
                          strokeLinecap="round"
        ...
        <div className="container mx-auto px-20">
          <div className="flex flex-col lg:flex-row gap-20">
            ...
            <div className="lg:w-1/2">
              ...
              <h2 className="font-merriweather text-5xl text-black mb-10">
                About Us
              </h2>
              <div className="space-y-6 mb-16">
                <p className="font-poppins text-xl text-gray-600 leading-relaxed">
                  Build India Realty LLP, established in 2021 and based in
                  Ahmedabad, Gujarat, is a RERA-compliant real estate firm
                  specializing in planned plot development across high-growth
                  corridors. Backed by the vision of our partners Tarun Kumar
                  and Avinash Hemantkumar Singh and supported by the RAV Group,
                  we bring transparency, trust, and innovation to every project.
                </p>
                <p className="font-poppins text-xl text-gray-600 leading-relaxed">
                  Our mission is to deliver secure, legally compliant, and
                  strategically located properties that ensure long-term value,
                  while focusing on customer satisfaction, compliance, and
                  sustainable growth.
                </p>
              </div>
            ...
            <div className="lg:w-1/2 flex flex-col justify-center">
              <div className="grid grid-cols-2 gap-12">
                <div className="text-center">
                  <h3 className="font-merriweather text-5xl text-black mb-3">
                    20+
                  </h3>
      ...
      <section className="py-24 bg-gray-100">
        ...
        <div className="container mx-auto px-20">
          <div className="text-center mb-20 flex flex-col">
            <h2 className="font-merriweather text-5xl text-black mx-auto mb-6">
              Our Projects
            </h2>
            <p className="font-poppins text-xl text-gray-600 max-w-3xl mx-auto">
              Showcasing thoughtfully planned projects designed for security,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            {[
              {
                image:
                  "https://api.builder.io/api/v1/image/assets/TEMP/2e2ac34f35bad624de699530f1755998cd93374e?width=1212",
              ...
              {
                image:
                  "https://api.builder.io/api/v1/image/assets/TEMP/b6734294995250b41307cd556efd9340063b493e?width=1564",
                title: "Rajpath Grand",
                location: "Dholera",
              ...
              {
                image:
                  "https://api.builder.io/api/v1/image/assets/TEMP/be64988a6b338e652a10d08023286aec46941e54?width=1212",
                title: "Green City",
                location: "Dholera",
                description:
                  "Your dream home in Dholera Smart City is within reach.",
                buttonText: "BOOKING OPEN",
              },
            ].map((project, index) => (
              <div key={index} className="bg-white rounded-lg overflow-hidden">
                ...
                <div className="p-8">
                  ...
                  <div className="flex items-center space-x-2 mb-4">
                    ...
                    <span className="font-poppins text-xl text-gray-600">
                      {project.location}
                    </span>
                  </div>
        ...
        <div className="container mx-auto px-20">
          <div className="flex flex-col lg:flex-row gap-20 mb-20">
            <div className="lg:w-1/2">
              ...
              <h2 className="font-merriweather text-5xl text-black mb-6 leading-tight">
                Prime Location
              </h2>
              <p className="font-poppins text-xl text-gray-600 leading-relaxed">
                Prime project locations offering excellent connectivity,
                convenience, and strong future growth potential.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-20">
          <div className="text-center mb-20">
            ...
            <p className="font-poppins text-xl text-gray-600 max-w-4xl mx-auto">
              India's first Greenfield Smart City with world-class
              infrastructure, global connectivity, and sustainable growth
              opportunities.
            </p>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            <p className="font-poppins text-xl text-gray-600 leading-relaxed mb-8">
              Dholera is India's first smart city in Gujarat, India, which is
              part of Delhi-Mumbai Industrial Corridor (DMIC) and direct access
              to globally market. It is approximately 100 kilometers southwest
              of the Ahmedabad, Gujarat.
            </p>
            <p className="font-poppins text-xl text-gray-600 leading-relaxed mb-8">
              Strategic location, planned infrastructure development,
              sustainability, and government support are major advantages of
              Dholera SIR. The Dholera Smart City is being planned to become a
              global manufacturing and commerce hub.
            </p>
            <p className="font-poppins text-xl text-gray-600 leading-relaxed">
              It will serve as a model for India's smart cities, accommodating 2
              million people and creating 800,000 jobs while promoting regional
        ...
        <div className="container mx-auto px-20">
          <div className="text-center mb-20">
            ...
            <p className="font-poppins text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Government-backed smart city offering prime connectivity,
              sustainable infrastructure, and high-return investment potential.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-12">
            {[
              {
                image:
                  "https://api.builder.io/api/v1/image/assets/TEMP/0d60dd888caaa7ea6464c8fb87873268b281a406?width=1814",
                title: "ABCD Building",
                description:
              ...
              {
                image:
                  "https://api.builder.io/api/v1/image/assets/TEMP/115264fc71c96764dd0f4ad42853b702bc8a1fef?width=2142",
              ...
              {
                image:
                  "https://api.builder.io/api/v1/image/assets/TEMP/07a5e4abf1359ab65d66657f2b88fe72222306bf?width=1820",
                title: "Metro Train",
                description:
              ...
              <div
                key={index}
                className="relative bg-white rounded-lg overflow-hidden h-96"
              >
                <img
                  src={item.image}
                  alt={item.title}
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-black bg-opacity-70 p-6">
                  <h3 className="font-poppins text-2xl font-medium text-white mb-2">
                    {item.title}
                  </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            {[
              {
                image:
                  "https://api.builder.io/api/v1/image/assets/TEMP/02d46d0fa9130df350f7eadf9fdf02b490f9dcb6?width=2126",
              ...
              {
                image:
                  "https://api.builder.io/api/v1/image/assets/TEMP/443004f8941b3f94c6f4c425b446e66e30783f7a?width=1250",
              ...
              {
                image:
                  "https://api.builder.io/api/v1/image/assets/TEMP/dfc466eb87fc11fdfcf152042eb431c91ad8ff0d?width=2006",
                title: "Kalpsar Dam",
                description:
        ...
        <div className="container mx-auto px-20">
          <div className="flex flex-col lg:flex-row gap-20">
            ...
            <div className="lg:w-1/3">
              <div className="w-52 h-1 bg-black mb-10"></div>
              <h2 className="font-merriweather text-5xl text-black mb-6 leading-tight">
                What they say after visit.
              </h2>
              <p className="font-poppins text-xl text-gray-600 leading-relaxed mb-8">
                Hear from our clients who trusted us to turn investments into
                lasting value.
              </p>
            ...
            <div className="lg:w-2/3 flex gap-6 overflow-hidden">
              {[1, 2, 3].map((_, index) => (
                <div
                  key={index}
                  className="bg-white rounded-3xl p-8 flex-shrink-0 w-96"
                >
                  {/* Star Rating */}
                  ...
                  <p className="font-poppins text-xl text-gray-600 leading-relaxed mb-6">
                    RAV Group made my first property purchase simple,
                    transparent, and rewarding - truly a trustworthy partner.
                  </p>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    />
                    <div>
                      <h4 className="font-poppins text-xl font-bold text-gray-600">
                        Anuj Singh
                      </h4>
      ...
      <footer className="bg-black text-white">
        ...
        <div className="py-20 px-20">
          <h2 className="font-merriweather text-5xl text-white mb-20">
          ...
          <div className="flex flex-wrap gap-32 mb-20">
            {[
              ...
              <div key={index} className="flex items-center space-x-6">
                ...
                <div>
                  <h3 className="font-poppins text-3xl font-medium">
                    {social.name}
                  </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <p className="font-poppins text-base text-white mb-6">
                Build India Reality LLP is a RERA-registered real estate company
                based in Ahmedabad, Gujarat. Backed by the RAV Group
              </p>
              <div className="flex space-x-6">
                {[1, 2, 3, 4].map((_, i) => (
                  <div
                    key={i}
                    className="w-12 h-12 border border-gray-600 rounded-full"
                  ></div>
                ))}
              </div>
            </div>
            ...
            {/* Quick Links */}
            <div>
              <h3 className="font-poppins text-base font-bold text-white mb-5">
                Quick Links
              </h3>
              <ul className="space-y-2">
                {[
                  ...
                  <li key={i}>
                    <a
                      href="#"
                      className="font-poppins text-base text-gray-400 hover:text-white transition"
                    >
                      {link}
                    </a>
                  </li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                {["Rajpath Enclave", "Rajpath Grand", "Green City"].map(
                  (project, i) => (
                    <li key={i}>
                      <a
                        href="#"
          ...
          <div className="border-t border-gray-600 pt-6">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="font-poppins text-base text-white mb-4 md:mb-0">
                @2025 BUILD INDIA REALITY
              </p>
              <div className="flex space-x-12">
                <a
                  href="#"
                  className="font-poppins text-base text-white hover:opacity-80 transition"
                >
                  Privacy Policy
                </a>
                <a
