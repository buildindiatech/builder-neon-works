...
export default function NewsDetail() {
  ...
  const relatedArticles = [
    {
      date: "August 17, 2025",
      image: "https://api.builder.io/api/v1/image/assets/TEMP/e1ab95c890b94050678836ff9bb87fe65f981497?width=840",
      title: "Investors Take Note : Dholera-Bhavnagar Rail Line Gets",
      description: "A perfect harmony of location, value and vision. A perfect harmony of location so...",
    },
    {
      date: "August 17, 2025", 
      image: "https://api.builder.io/api/v1/image/assets/TEMP/e1ab95c890b94050678836ff9bb87fe65f981497?width=840",
      ...
      <div className="flex w-full px-[400px] pt-20 pb-40 flex-col items-center gap-20 bg-gradient-to-b from-white to-white">
        <div className="flex flex-col items-start gap-15 self-stretch">
          ...
          <div className="self-stretch text-gray-600 font-poppins text-xl font-normal leading-[1.8] mb-15">
            The Gujarat government has announced a significant boost to the development of Dholera Special Investment Region (DSIR), approving a new wave of infrastructure projects aimed at transforming the region into a globally competitive smart city. The approvals highlight industrial expansion, smart utilities, and green energy initiatives, all designed to accelerate growth in India's first Greenfield Smart City.
          </div>
          ...
          <div className="flex flex-col items-start gap-5 self-stretch mb-15">
            ...
            <div className="self-stretch text-gray-600 font-poppins text-xl font-normal leading-[1.8]">
              A key part of the approval package focuses on expanding industrial corridors within DSIR. New land parcels have been earmarked for manufacturing units, logistics hubs, and export-oriented industries, particularly in high-demand sectors such as electronics, automotive, and renewable energy equipment. The government expects these zones to attract both domestic and foreign direct investment, positioning Dholera as a manufacturing powerhouse along the Delhi–Mumbai Industrial Corridor (DMIC).
              <br /><br />
              Officials estimate that the industrial expansion will generate thousands of new jobs over the next five years, fueling migration and settlement in the area. This move not only strengthens the state's industrial base but also ensures sustainable demand for residential and commercial properties within Dholera.
            </div>
          </div>
          ...
          <div className="flex flex-col items-start gap-5 self-stretch mb-15">
            ...
            <div className="self-stretch text-gray-600 font-poppins text-xl font-normal leading-[1.8]">
              Alongside industrial expansion, the government has cleared new urban infrastructure projects designed to align with global smart city standards. These include :
              <br /><br />
              Road and Highway Upgrades: Seamless connectivity between the Ahmedabad–Dholera Expressway and internal township roads.<br />
              ICT-Enabled Utilities: Smart power grids, water management systems, and underground cabling.<br />
              Drainage and Sewage Systems: Sustainable urban drainage ensuring climate resilience.<br />
              Public Amenities: Planned healthcare, education, and recreational facilities integrated into the city's blueprint.
              <br /><br />
              By combining technology, sustainability, and urban planning, Dholera is expected to provide a world-class quality of life, attracting investors, residents, and corporate tenants.
            </div>
          </div>
          ...
          <div className="flex flex-col items-start gap-5 self-stretch mb-15">
            ...
            <div className="self-stretch text-gray-600 font-poppins text-xl font-normal leading-[1.8]">
              With industrial activity projected to surge, the government has also emphasized balanced residential and commercial growth. New approvals cover integrated townships, affordable housing clusters, shopping complexes, and business parks. This ensures that as the workforce grows, there will be adequate housing, retail, and lifestyle amenities to support them.
              <br /><br />
              Real estate experts predict that this wave of development will drive up land and property values in Dholera, making it one of the most promising real estate investment hotspots in India.
            </div>
          </div>
          ...
          <div className="flex flex-col items-start gap-5 self-stretch mb-15">
            ...
            <div className="self-stretch text-gray-600 font-poppins text-xl font-normal leading-[1.8]">
              In line with India's commitment to sustainability, the newly approved projects also integrate renewable energy solutions. These include grid connections for the 5,000 MW Dholera Solar Park, energy-efficient street lighting, and eco-friendly building codes. The focus is to make Dholera not only an economic hub but also a model of sustainable urban development.
            </div>
          </div>
          ...
          <div className="flex flex-col items-start gap-5 self-stretch mb-15">
            ...
            <div className="self-stretch text-gray-600 font-poppins text-xl font-normal leading-[1.8]">
              Industry observers believe that these approvals will serve as a catalyst for investor confidence. With rapid infrastructure rollout, Dholera is set to become a preferred destination for NRI investors, industrialists, and first-time buyers seeking high returns. Analysts forecast a 10–15% annual appreciation in property values over the next few years, with demand for plots and commercial spaces already on the rise.
            </div>
          </div>
          ...
          <div className="flex flex-col items-start gap-5 self-stretch">
            ...
            <div className="self-stretch text-gray-600 font-poppins text-xl font-normal leading-[1.8]">
              The Gujarat government's approval of these new infrastructure projects marks a turning point in Dholera's growth story. By strengthening industrial capacity, urban infrastructure, housing, and sustainability, the state is laying the foundation for a smart city that is both economically vibrant and environmentally responsible.
              <br /><br />
              For investors, the message is clear: Dholera is not just the future of Gujarat, but a symbol of India's urban transformation.
            </div>
          </div>
      ...
      <div className="flex w-full px-[400px] pt-40 pb-40 flex-col items-start gap-20">
        ...
        <div className="flex items-center gap-10 self-stretch">
          {relatedArticles.map((article, idx) => (
            <div key={idx} className="flex w-[500px] p-10 flex-col items-center gap-[26px] rounded border border-white/70 bg-white">
        ...
        <div className="flex px-40 pb-6 flex-col items-start gap-2 self-stretch">
              ...
              <div className="flex justify-between items-start self-stretch">
                ...
                <div className="flex w-[432px] flex-col items-start gap-6">
                  ...
                  <div className="flex items-center gap-[26px]">
                    ...
                    <div className="w-12 h-12 relative">
                      <svg className="w-12 h-12 stroke-gray-600" viewBox="0 0 50 50" fill="none">
                        <path fillRule="evenodd" clipRule="evenodd" d="M25 49C38.2548 49 49 38.2548 49 25C49 11.7452 38.2548 1 25 1C11.7452 1 1 11.7452 1 25C1 38.2548 11.7452 49 25 49Z" stroke="#474747"/>
                      </svg>
                      <svg className="w-[18px] h-[18px] absolute left-4 top-[14px]" viewBox="0 0 19 19" fill="none">
                        <g clipPath="url(#clip0_764_301)">
                          <path d="M12.5977 6.22784C13.7911 6.22784 14.9357 6.70195 15.7796 7.54586C16.6235 8.38978 17.0977 9.53437 17.0977 10.7278V15.9778H14.0977V10.7278C14.0977 10.33 13.9396 9.94849 13.6583 9.66718C13.377 9.38588 12.9955 9.22784 12.5977 9.22784C12.1998 9.22784 11.8183 9.38588 11.537 9.66718C11.2557 9.94849 11.0977 10.33 11.0977 10.7278V15.9778H8.09766V10.7278C8.09766 9.53437 8.57176 8.38978 9.41568 7.54586C10.2596 6.70195 11.4042 6.22784 12.5977 6.22784Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                          <path d="M5.09766 6.97784H2.09766V15.9778H5.09766V6.97784Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                          <path d="M3.59766 4.72784C4.42608 4.72784 5.09766 4.05627 5.09766 3.22784C5.09766 2.39942 4.42608 1.72784 3.59766 1.72784C2.76923 1.72784 2.09766 2.39942 2.09766 3.22784C2.09766 4.05627 2.76923 4.72784 3.59766 4.72784Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                        </g>
                      </svg>
                    </div>
                    ...
                    <div className="w-12 h-12 relative">
                      ...
                      <svg className="w-[18px] h-[18px] absolute left-[15px] top-[14px]" viewBox="0 0 19 19" fill="none">
                        <path d="M14.4805 1.90154H12.2305C11.2359 1.90154 10.2821 2.29662 9.57882 2.99988C8.87556 3.70315 8.48047 4.65697 8.48047 5.65153V7.90153H6.23047V10.9015H8.48047V16.9015H11.4805V10.9015H13.7305L14.4805 7.90153H11.4805V5.65153C11.4805 5.45262 11.5595 5.26186 11.7001 5.1212C11.8408 4.98055 12.0316 4.90153 12.2305 4.90153H14.4805V1.90154Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                    </div>
                    ...
                    <div className="w-12 h-12 relative">
                      ...
                      <svg className="w-[18px] h-[18px] absolute left-[15px] top-4" viewBox="0 0 19 19" fill="none">
                        <g clipPath="url(#clip0_764_309)">
                          <path d="M13.6367 5.82419H13.6442M5.76172 2.44919H13.2617C15.3328 2.44919 17.0117 4.12812 17.0117 6.19919V13.6992C17.0117 15.7703 15.3328 17.4492 13.2617 17.4492H5.76172C3.69065 17.4492 2.01172 15.7703 2.01172 13.6992V6.19919C2.01172 4.12812 3.69065 2.44919 5.76172 2.44919ZM12.5117 9.47669C12.6043 10.1009 12.4977 10.7383 12.207 11.2984C11.9164 11.8585 11.4566 12.3127 10.8929 12.5964C10.3293 12.8801 9.69055 12.9789 9.06756 12.8786C8.44456 12.7784 7.86904 12.4842 7.42285 12.0381C6.97666 11.5919 6.68252 11.0163 6.58227 10.3933C6.48202 9.77035 6.58077 9.13161 6.86446 8.56797C7.14816 8.00433 7.60236 7.54449 8.16246 7.25387C8.72256 6.96324 9.36003 6.85663 9.98422 6.94919C10.6209 7.0436 11.2104 7.34029 11.6655 7.79542C12.1206 8.25055 12.4173 8.84 12.5117 9.47669Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                        </g>
                      </svg>
                    </div>
                    ...
                    <div className="w-12 h-12 relative">
                      ...
                      <svg className="w-[18px] h-[18px] absolute left-[15px] top-4" viewBox="0 0 19 19" fill="none">
                        <g clipPath="url(#clip0_764_313)">
                          <path d="M17.4171 5.76115C17.3281 5.40521 17.1466 5.07908 16.8911 4.81571C16.6357 4.55233 16.3152 4.36104 15.9621 4.26115C14.6721 3.94615 9.51215 3.94615 9.51215 3.94615C9.51215 3.94615 4.35215 3.94615 3.06215 4.29115C2.70908 4.39104 2.38863 4.58233 2.13316 4.84571C1.87768 5.10908 1.69624 5.43521 1.60715 5.79115C1.37106 7.10032 1.25557 8.42838 1.26215 9.75865C1.25373 11.0989 1.36922 12.4371 1.60715 13.7562C1.70537 14.101 1.89088 14.4148 2.14576 14.667C2.40063 14.9193 2.71626 15.1015 3.06215 15.1962C4.35215 15.5412 9.51215 15.5412 9.51215 15.5412C9.51215 15.5412 14.6721 15.5412 15.9621 15.1962C16.3152 15.0963 16.6357 14.905 16.8911 14.6416C17.1466 14.3782 17.3281 14.0521 17.4171 13.6962C17.6514 12.3968 17.7669 11.0789 17.7621 9.75865C17.7706 8.41837 17.6551 7.08018 17.4171 5.76115Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                          <path d="M7.82465 12.2112L12.1371 9.75865L7.82465 7.30615V12.2112Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                        </g>
                      </svg>
                    </div>
                  </div>
                ...
                <div className="w-[206px] h-[259px]">
                  <div className="flex w-[206px] flex-col items-start gap-5 h-[259px]">
                    ...
                    <div className="flex flex-col items-start gap-2 self-stretch">
                      <div className="self-stretch text-gray-400 font-poppins text-base font-normal">Home</div>
                      <div className="self-stretch text-gray-400 font-poppins text-base font-normal">About Us</div>
                      <div className="self-stretch text-gray-400 font-poppins text-base font-normal">Project</div>
                      <div className="self-stretch text-gray-400 font-poppins text-base font-normal">Dholera SIR</div>
                      <div className="self-stretch text-gray-400 font-poppins text-base font-normal">News</div>
                      <div className="self-stretch text-gray-400 font-poppins text-base font-normal">Gallery</div>
                      <div className="self-stretch text-gray-400 font-poppins text-base font-normal">Join Us</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="w-[205px] h-[131px]">
                  <div className="flex w-[205px] flex-col items-start gap-5 h-[131px]">
                    ...
                    <div className="flex flex-col items-start gap-2 self-stretch">
                      <div className="self-stretch text-gray-400 font-poppins text-base font-normal">Rajpath Enclave</div>
                      <div className="self-stretch text-gray-400 font-poppins text-base font-normal">Rajpath Grand</div>
                      <div className="self-stretch text-gray-400 font-poppins text-base font-normal">Green City</div>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="flex flex-col items-start gap-2">
                      ...
                      <div className="flex items-center gap-[18px] self-stretch">
                        <svg className="w-3 h-3" viewBox="0 0 12 12" fill="none">
                          <path d="M11 3.00327C11 2.45327 10.55 2.00327 10 2.00327H2C1.45 2.00327 1 2.45327 1 3.00327M11 3.00327V9.00327C11 9.55327 10.55 10.0033 10 10.0033H2C1.45 10.0033 1 9.55327 1 9.00327V3.00327M11 3.00327L6 6.50327L1 3.00327" stroke="white" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                        <div className="text-gray-400 font-poppins text-base font-normal">
          ...
          <div className="flex w-[969px] justify-between items-center">
            ...
            <div className="flex items-center gap-15 self-stretch">
              <div className="text-white font-poppins text-base font-normal">Privacy Policy</div>
              <div className="text-white font-poppins text-base font-normal">Terms of Service</div>
              <div className="text-white font-poppins text-base font-normal">Refund Policy</div>
            </div>
          </div>
        </div>
      </footer>
