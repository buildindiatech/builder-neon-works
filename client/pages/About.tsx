        ...
        <div className="container mx-auto px-40">
          <div className="text-center mb-20">
            ...
            <p className="font-poppins text-xl text-gray-600 leading-relaxed max-w-6xl mx-auto">
              At Build India Realty LLP, we go beyond land development — we
              create secure, future-ready opportunities for individuals and
              families who aspire to grow with their investments. Based in
              Ahmedabad, Gujarat, and established in 2021, we are a
              RERA-compliant real estate LLP specializing in planned plot
              development across high-growth corridors.
            </p>
            <br />
            <p className="font-poppins text-xl text-gray-600 leading-relaxed max-w-6xl mx-auto">
              Backed by the vision of our designated partners, Tarun Kumar and
              Avinash Hemantkumar Singh, and supported by the strong foundation
              of the RAV Group, we bring transparency, trust, and innovation to
              every project we deliver. Our mission is simple: to offer legally
              secure, strategically located, and value-driven properties that
              stand the test of time.
            </p>
            <br />
            <p className="font-poppins text-xl text-gray-600 leading-relaxed max-w-6xl mx-auto">
              With a focus on customer satisfaction, compliance, and sustainable
              growth, Build India Realty LLP is committed to redefining land
              ownership and creating lasting value for all stakeholders.
            </p>
          </div>
        ...
        <div className="container mx-auto px-40">
          <div className="text-center mb-20">
            ...
            <p className="font-poppins text-xl text-gray-600">
              Committed to transparency, trust, and innovation, our mission is
              delivering secure, future-ready investments with lasting value.
            </p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-20">
            ...
            <div className="flex-1 relative">
              <div className="relative w-full max-w-4xl mx-auto h-96">
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 rounded-full border-12 border-gray-400 bg-white flex items-center justify-center">
                  <h3 className="font-merriweather text-3xl font-bold text-black text-center">
                    CORE
                    <br />
                    VALUES
                  </h3>
                ...
                <div className="absolute top-14 left-1/2 transform -translate-x-1/2 flex flex-col items-center">
                  ...
                  <span className="font-poppins text-2xl font-bold text-gray-600 mt-2">
                    Trust
                  </span>
                </div>
                ...
                <div className="absolute top-1/2 right-0 transform -translate-y-1/2 flex flex-col items-center">
                  ...
                  <span className="font-poppins text-2xl font-bold text-gray-600 mt-2 ml-16">
            ...
            <div className="flex-1 space-y-20">
              <div className="bg-white p-10 rounded">
                <h3 className="font-poppins text-2xl text-black mb-10">
                  Our Value
                </h3>
                <p className="font-poppins text-xl text-gray-600 leading-relaxed">
                  Transparency, trust, and innovation define Build India Realty.
                  We value customer satisfaction, compliance, and sustainable
                  growth, creating secure, future-ready opportunities that
                  deliver long-term benefits for families, investors, and
                  communities.
                </p>
              </div>
              ...
              <div className="bg-white p-10 rounded">
                ...
                <p className="font-poppins text-xl text-gray-600 leading-relaxed">
                  Our mission is to redefine land ownership by delivering
                  RERA-approved, strategically located projects. We aim to
                  provide legally secure, value-driven investments that ensure
                  growth, reliability, and lasting prosperity for stakeholders.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-40 relative">
        ...
        <div className="relative container mx-auto px-40">
          <div className="max-w-4xl">
            <h2 className="font-merriweather text-6xl text-black mb-10">
              Who we are
            </h2>
            <p className="font-poppins text-2xl text-gray-600 leading-relaxed mb-8">
              Founded in 2021, Build India Realty LLP is a registered Limited
              Liability Partnership (LLPIN: AAY-9079) operating in the real
              estate sector. Headquartered in Ahmedabad, Gujarat, the firm is
              actively engaged in plot development and allied real estate
              solutions, with a strong emphasis on RERA compliance,
          ...
          <div className="flex flex-col lg:flex-row gap-30">
            ...
            <div className="lg:w-1/3 flex flex-col justify-center">
              ...
              <p className="font-poppins text-xl text-gray-600 mb-16">
                We create secure, RERA-approved real estate opportunities
                focused on growth, trust, and sustainability.
              </p>
            ...
            <div className="lg:w-2/3 grid grid-cols-1 md:grid-cols-3 gap-12">
              <div className="bg-white p-6 rounded flex flex-col items-center text-center">
                ...
                />
                <p className="font-poppins text-xl text-gray-600">
                  RERA-Compliant Plot Development in high-potential growth
                  corridors
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded flex flex-col items-center text-center">
                ...
                />
                <p className="font-poppins text-xl text-gray-600">
                  Transparent and Legally Secure Transactions ensuring customer
                  confidence
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded flex flex-col items-center text-center">
                ...
                />
                <p className="font-poppins text-xl text-gray-600">
                  Sustainable Planning with a focus on community growth and
      ...
      <section className="py-40 bg-white">
        <div className="container mx-auto px-40">
          <div className="text-center mb-20">
            ...
            <p className="font-poppins text-xl text-gray-600">
              Guided by visionary leaders dedicated to trust, transparency, and
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            ...
            <div className="relative">
              ...
              <div className="bg-white p-10 rounded shadow-lg">
                <h3 className="font-poppins text-2xl text-black mb-6">
                  Mr. Tarun Kumar
                </h3>
                <p className="font-poppins text-xl text-gray-600">
